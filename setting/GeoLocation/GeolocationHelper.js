...
var GeolocationHelper = function( filters) {
    ...
    this.filter = function(accuracy, callback) {
        ...
        locationObject.med_lat = med_lat;                  
        locationObject.med_lon = med_lon;                  
        locationObject.med_accuracy = med_accuracy;        
        locationObject.med_speed = med_speed;             
        locationObject.med_distance = med_distance;        
        locationObject.med_time_diff = med_timediff;       
        locationObject.stddev_lat = stddev_lat;           
        locationObject.stddev_lon = stddev_lon;           
        locationObject.stddev_accuracy = stddev_accuracy; 
        locationObject.stddev_distance = stddev_distance;  
