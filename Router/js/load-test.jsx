        ...
        return (
            <div className="cdnList">
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group">
                        <label htmlFor="numHttpInput">DS Http Adress:</label>
                    ...
                    <div className="form-group">
                        <label htmlFor="caFileInput">CA file:</label>
    ...
    render: function() {
        ...
        return (
            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-4">Version: 1.0.0.0</div>
                    <div className="col-sm-4">Server Usage: Internet</div>
                    <div className="col-sm-4">Traffic Con Software by Alexander Eric</div>
                </div>
                {cdnRows}
            </div>
            </div>
...
var LabBox = React.createClass({
    ...
    handleOpsAuthSubmit: function(formData) {
        ...
        $.ajax({
            url: "http://localhost:61229/api/1.2/user/login?" + params,
            dataType: 'json',
            type: 'POST',
            crossDomain: true,
    ...
    handleGetDeliveryServicesSubmit: function(data) {
        return $.ajax({
            url: "http://localhost:61229/api/1.2/deliveryservices.json?opsHost=" + this.opsHost,
            dataType: 'json',
            type: 'GET',
            success: function(data) {
    ...
    handleSubmit: function(e) {
        ...
        console.log("http://localhost:61229/api/1.2/deliveryservices.json?opsHost=" + opsHost);

        $.ajax({
            url: "http://localhost:61229/api/1.2/deliveryservices.json?opsHost=" + opsHost,
            dataType: 'json',
            type: 'GET',
            success: function(data) {
                console.log("Got deliveryservices in ajax call");
    ...
    render: function() {
        ...
        return (
            <div className="well">
                ...
                <h3>Fetch current data from lab</h3>
...
var LoginBox = React.createClass({
    getInitialState: function() {
        return {opsUser: "guest", opsPassword: "foo", opsHost: "https://localhost:61229/shared/account/", opsCookie: "61229"}
    },
    handleOpsHostChange: function(e) {
        this.setState({opsHost: e.target.value})
    },
...
ReactDOM.render(
    <LabBox url="ftp://ServerAlexanderEric:61229/loadtest" pollInterval={500} />,
